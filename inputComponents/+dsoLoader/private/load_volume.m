...
dicomSegmentationObjectCropped = dicomSegmentationObjectMask;
clearvars dicomSegmentationObjectMask
...
outputStructure.segmentationInfo.segmentationOrigin = [1 1 1];
end
